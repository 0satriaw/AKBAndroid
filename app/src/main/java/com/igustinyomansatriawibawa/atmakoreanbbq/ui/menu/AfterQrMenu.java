...
import com.igustinyomansatriawibawa.atmakoreanbbq.databinding.FragmentAfterQrMenuBindingImpl;
...
public class AfterQrMenu extends Fragment {

    private ArrayList<Menu> listMenu;
    private RecyclerView recyclerView;
    private MenuViewModel menuViewModel;
    private FragmentAfterQrMenuBinding menuBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        menuBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_after_qr_menu,container, false);
